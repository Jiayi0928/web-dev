...
console.log('Legacy ES6 functions');
const subtract = (a, b) => {
    return a - b;
}
...
const init = () => {
    ...
    const hideMe = $("#hide-me"); hideMe.hide();

    const showMe = $("#show-me"); showMe.show();
    ...
    const clickable = $('.clickable'); clickable.click(handleClick);
    ...
    let hideBtn, showBtn, hideShowHeader; hideBtn = $('#hide');
    showBtn = $('#show'); hideShowHeader = $('#hide-show'); const hideHandler = () => {
        hideShowHeader.hide(); }
    const showHandler = () => { hideShowHeader.show();
    }
    hideBtn.click(hideHandler); showBtn.click(showHandler);
